# Notes for writing analyzer tests
I'm making a temporary notes.md file to build out some analyzer tests. I don't want to mess with the one existing analyze.test.js as it's in a different format. 
...
const semanticChecks = [
  ...
  ["assign to array element", "const a: [int] = [1,2,3]; a[1] = 100;"],
  ["initialize with empty optional", "var a: int? = None;"],
  // ["short return", "void f() { return; }"],
  ["return statement", "bool f() { return true; }"],
  ["assign optionals", "var a: int? = None;var b=some 1;a=b;b=a;"],
