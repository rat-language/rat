const semanticChecks = [
  ...
  ["call of assigned functions", 'function f(x: int) {} const g : function = f; g(1);'],
  ["type equivalence of nested arrays", 'function f(x: [[int]]) {} print(f([[1],[2]]));'],
  ["call of assigned function in expression", 'function f(x: int, y: boolean) {} const g: function = f; print(g(1, true)); f = g;'],
  ["pass a function to a function", 'function f(x: int, y: function) { return 1; } function g(z: boolean) {} f(2, g);'],
  ["function return types", 'function square(x: int) { return x * x; } function compose() { return square;}'],
